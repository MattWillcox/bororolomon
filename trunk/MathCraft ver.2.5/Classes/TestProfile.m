...
- (void)testCreateProfile{
	...
	STAssertTrue([Profile createUserProfile:@"Mike" Password:@"Mike'spassword"], @"Part 1");
	STAssertTrue([Profile saveUserProfile], @"Part 2");
	STAssertEqualObjects(Profile.LoggedinUser.UserName, @"Mike", @"Part3");
	NSLog(@"%@ end", self.name);
}
