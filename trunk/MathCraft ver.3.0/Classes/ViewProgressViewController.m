...
-(IBAction)score_Pressed{
	...
	if (profile.LoggedinUser.IsGuestUser){
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Guest cannot submit scores!" 
														message:@"You must log in before submitting your score to Online Leaderboard." 
													   delegate:nil 
...
- (void)viewDidLoad {
	scrollView.contentSize = CGSizeMake(480, 1200);
	ManageProfile *profile = [ManageProfile sharedManager];
