...
-(IBAction)back_Pressed{
	...
	if (timeLeft == 0) {
		...
		profile.LoggedinUser.MirrorGame2Average = 
		((profile.LoggedinUser.MirrorGame2Average*(float)profile.LoggedinUser.MirrorGame2Played) + (float)score) / ((float)profile.LoggedinUser.MirrorGame2Played+1);
		profile.LoggedinUser.MirrorGame2Played++;
