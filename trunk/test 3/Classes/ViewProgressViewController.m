...
-(IBAction)score_Pressed{
	...
	NSString *response = [self submitHighScore: profile.LoggedinUser.UserName score: totalScore url:@"MathCraft"];
}
/*
...
- (void)viewDidLoad {
	...
	equationGame1AverageLabel.text = [NSString stringWithFormat:@"%ld",profile.LoggedinUser.EquationGame1Average];
	equationGame2AverageLabel.text = [NSString stringWithFormat:@"%ld",profile.LoggedinUser.EquationGame2Average];
	moneyGame1AverageLabel.text = [NSString stringWithFormat:@"%ld",profile.LoggedinUser.MoneyGame1Average];
	moneyGame2AverageLabel.text = [NSString stringWithFormat:@"%ld",profile.LoggedinUser.MoneyGame2Average];
	mirrorGame1AverageLabel.text = [NSString stringWithFormat:@"%ld",profile.LoggedinUser.MirrorGame1Average];
	mirrorGame2AverageLabel.text = [NSString stringWithFormat:@"%ld",profile.LoggedinUser.MirrorGame2Average];
	clockGame1AverageLabel.text = [NSString stringWithFormat:@"%ld",profile.LoggedinUser.ClockGame1Average];
	clockGame2AverageLabel.text = [NSString stringWithFormat:@"%ld",profile.LoggedinUser.ClockGame2Average];
