...
-(IBAction) back_button {
	...
	if (timeLeft == 0) {
		...
		profile.LoggedinUser.MoneyGame1Average = 
		((profile.LoggedinUser.MoneyGame1Average*(float)profile.LoggedinUser.MoneyGame1Played) + (float)totalScore) / ((float)profile.LoggedinUser.MoneyGame1Played+1);
		profile.LoggedinUser.MoneyGame1Played++;
