...
-(IBAction) returnpreviouspage{
	...
	if (timeleft == 0) {
		...
		profile.LoggedinUser.ClockGame2Average = 
		((profile.LoggedinUser.ClockGame2Average*(float)profile.LoggedinUser.ClockGame2Played) + (float)score) / ((float)profile.LoggedinUser.ClockGame2Played+1);
		profile.LoggedinUser.ClockGame2Played++;
