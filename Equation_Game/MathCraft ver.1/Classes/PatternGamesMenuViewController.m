...
-(IBAction)Game1_Push {
	MIrrorGameViewController *gamemenuscreen = [[MIrrorGameViewController alloc] initWithNibName:nil bundle:nil];
...
-(IBAction)Game2_Push{
	PatternGame2ViewController *gamemenuscreen = [[PatternGame2ViewController alloc] initWithNibName:nil bundle:nil];
	gamemenuscreen.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
	[self presentModalViewController:gamemenuscreen animated:YES];
	[gamemenuscreen release];
